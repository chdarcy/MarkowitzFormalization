...
/-!
# Comparator Challenge — Risk-Free Frontier Optimality

Mathlib-only statement of `rfFrontierPortfolio_optimal`. The definitions required to
...
/-- **Risk-free frontier optimality** (challenge statement): among all risky exposure
